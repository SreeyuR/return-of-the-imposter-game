...
/**
 * Returns the unit vector in the direction of the given vector, or the zero
 * vector if the magnitude of the vector is 0
 *
 * @param v the vector
 * @return the unit vector in the direction of v, or VEC_ZERO if the magnitude
 * of v is 0
 */
...
/**
 * Initializes a pointer to a vector
 *
 * @param x the x-component
 * @param y the y-component
 * @return a pointer to a vector with the given components
 */
 ...
 * @return a pointer to a new vector with the same data
 */
